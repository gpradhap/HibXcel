package com.gs.common.dao.exception;

import org.apache.commons.lang.StringUtils;

public class AttrLookupGroupDaoException   extends Exception{
	...
	public AttrLookupGroupDaoException() {
	}

	public AttrLookupGroupDaoException(String errorMsg) {
		this.errorMsg = errorMsg;
	}

	public AttrLookupGroupDaoException(String errorCode, String errorMsg) {
		this.errorCode = errorCode; 
		this.errorMsg = errorMsg;
	}

	public AttrLookupGroupDaoException(String errorCode, String errorMsg, String rootException) {
		this.errorCode = errorCode; 
		this.errorMsg = errorMsg;
